...
This project is about relational databases. It involves practising introductory SQL data definitions and data manipulation language, making subqueries, and using functions.
