...
This is a project about importing and using functions and creating modules in Python. It also involves the use of the builtin function `dir()` and using command line arguments within Python programs.
