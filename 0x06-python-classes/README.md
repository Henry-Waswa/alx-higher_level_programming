...
This project is about  object-oriented programming using classes and objects in Python. It also deals with attributes, methods, and properties as well as data abstraction, data encapsulation, and information hiding.
